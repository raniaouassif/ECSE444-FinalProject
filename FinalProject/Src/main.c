...
uint8_t res;
uint8_t *seq;
uint8_t mem_seq[5] = {1,2,3,4,5};
uint8_t digit_answer[6];
uint8_t digits[] = "12345";

uint8_t direction_answer[6];
uint8_t directions[]= "nseww";
...
/////////////////////// PLAYER Digit ////////////////////////
  ...
  if (game_mode[0] == '1'){
	  ...
	  //////////////////////////////////////////////////////////////////////////////
	  //TODO: send to HAL_DAC...
	  //once cmplt user should begin moving the board
	  //
	  //////////////////////////////////////////////////////////////////////////////
